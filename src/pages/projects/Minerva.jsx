    ...
    <>
      ...
      >
        <motion.picture
          ...
          className='h-1/2 self-start md:max-w-4xl xl:maw-w-5xl 2xl:max-w-276 md:self-center'
        >
          <source
        ...
        >
          ...
          <p className='text-center font-semibold text-soft-text sombra'>
            {t('subtitle')}
          </p>
        </motion.div>
      ...
      <main>
        ...
        <section className='text-lg md:text-xl '>
          <article className='p-10 w-full flex flex-col gap-10 items-center'>
            ...
            <div
              className='text-sm text-soft-text 
          ...
          <article className='w-full p-10 flex flex-col gap-10 md:gap-10 '>
            ...
            >
              <div
                className='text-sm text-soft-text text-center 
